...
$systemMappings = @(
    ...
    @{ Local = "$rootDir\media";        Remote = "$remoteBase/media";  Name = "Favorites Box Art (per-system subfolders)" },
    @{ Local = "$rootDir\media\images"; Remote = "$remoteBase/media";  Name = "Full Library Box Art (all scraped art + Console Mode)" },
